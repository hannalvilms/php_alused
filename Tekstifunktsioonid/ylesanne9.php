...
//Kuna on teada, et PHP käsitleb teksti kui massiivi, siis peaks saama seda
//tsükli abil nö. tükeldada. Ülesandeks on etteantud teksti iga tähe järgi
//lisada punkt.
...
//Näiteks: sisend–>Ülle ja Doos; väljund–>ylle.doos@hkhk.edu.ee<?php

$eesNimi = "Ülle";
$pereNimi = "Doos";
$otsi = array('Ü', 'Õ', 'Ö', 'Ä', 'ü', 'õ', 'ö', 'ä');
$asenda = array('y', 'o', 'o', 'a', 'y', 'o', 'o', 'a');
$eesnimiVaike = str_replace($otsi, $asenda, $eesNimi);
$perenimiVaike = str_replace($otsi, $asenda, $pereNimi);
echo strtolower($eesnimiVaike.'.'.$perenimiVaike.'@khk.edu.ee');
echo '<hr>';